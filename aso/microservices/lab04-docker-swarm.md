...
--------------
Docker Swarm permite orquestrar containers em um cluster formado por vários servidores. Desta forma conseguimos garantir as seguintes propriedades nos containers gerenciados pelo orquestrador:
...
5. **[T1]** Navegar até a pasta ***/fiap/aso/swarm/v1*** deste repositório *git*:
...
12. **[T1]** Conferir quais containers foram criados na primeira máquina virtual (neste caso o banco de dados e uma instancia da API):
...
13. **[T2]** Conferir quais containers foram criados na segunda máquina virtual (neste caso duas instancias da API):
