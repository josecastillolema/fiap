...
Neste lab sobre **Simple Storage Service (S3)** aprenderemos alguns conceitos importantes do armazenamento de objetos:
 - Criação de *buckets*
 - Criação de objetos
...
17. Fazer *upload* do arquivo [`index.html`](/mob/cloud/lab05-iaas-s3/index.html) (ou de qualquer outro arquivo `html`) com permissão de acesso público, como descrito na [criação de objeto](#criação-do-objeto)
